...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Floating Mic Button → Smart Assistant */}
      <Link
        href="/assistant"
        className="fixed bottom-6 right-6 z-50 w-16 h-16 lg:w-20 lg:h-20 bg-cta text-white rounded-full shadow-2xl flex items-center justify-center hover:bg-cta/90 active:scale-95 transition-all focus:ring-4 focus:ring-cta focus:ring-offset-2"
        aria-label={t("home.voiceAssistant") || "Voice Assistant"}
