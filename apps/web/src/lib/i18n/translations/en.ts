export const en = {
    ...
    help: {
        ...
        hours: "Support Hours",
        guides: "User Guides",
        emergencyHelpline: "24x7 Emergency Helpline",
        available24x7: "Available 24x7, toll-free",
        emailResponse: "Response within 24 hours",
        office: "Office",
        officeAddress: "SUVIDHA Civic Center, Main Road, City - 781001",
        officeHours: "Mon-Sat: 8 AM - 8 PM",
        quickLinks: "Quick Links & Guides",
        ...
        faq1q: "How do I pay my electricity bill?",
        faq1a: "Go to Electricity → Pay Bill. Select your connection, view the bill details, and complete the payment using UPI, card, or net banking.",
        faq2q: "How do I file a grievance?",
        faq2a: "Navigate to Grievances → File New Grievance. Select the category, describe the issue, attach photos if needed, and submit. You'll receive a tracking ID.",
        faq3q: "How do I apply for a new connection?",
        faq3a: "Go to the relevant service (Electricity/Gas/Water) → New Connection. Fill in the application form with required documents and submit.",
        faq4q: "How do I track my grievance status?",
        faq4a: "Go to Grievances → Track Status. Enter your tracking ID or view all your submitted grievances with their current status.",
        faq5q: "What payment methods are accepted?",
        faq5a: "We accept UPI, credit/debit cards, net banking, and digital wallets. All transactions are secured with encryption.",
    },
    common: {
        loading: "Loading...",
